...
function fnExcelReport() {
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Tabela Handover</h1>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="tile">
            ...
            <form class="form-inline" role="form"   method="POST" action="pesq_dc.php" style="margin-left:10%;">
...
<div style="float:left;" class="bootstrap-iso">
  ...
  <div class="row">
     ...
     <div class="form-group ">
      ...
      <input type="text" class="form-control"  name="dc" placeholder="Pesquisa" required >
    </div>
      </div>
     </div>
...
$sql = mysql_query ("select * from base join cadastro on base.dc = cadastro.dc where base.dc = '$dc' and base.cadastro = 'S' order by base.data_abertura desc" );
}
else
{
    $sql = mysql_query ("select * from base join cadastro on base.dc = cadastro.dc where base.dc = '$dc' and base.cadastro = 'S' and cadastro.id_tec = '".$_SESSION['id']."' order by data_abertura desc" );
...
?>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $dado ["centro"];  ?></td>
                    <td><?php echo $dado ["pep4"];  ?></td>
                    <td><?php echo $dado ["descricao"];  ?></td>
                    <td><?php echo $dado ["sigla"];  ?></td>
                    <td><?php echo $dado ["estacao"];  ?></td>
                    <td><?php echo $dado ["cnl"];  ?></td>
                    <td><?php echo $dado ["localidade"];  ?></td>
                    <td><?php echo $dado ["tipo_servico"];  ?></td>
                    <td><?php echo $dado ["tipo_projeto"];  ?></td>
                    <td><?php echo $dado ["contrato"];  ?></td>
                    <td><?php echo $dado ["prioridade"];  ?></td>
                    <td><?php echo $dado ["handover"];  ?></td>
                    <td><?php echo $dado ["data_abertura"];  ?></td>
                    <td><?php echo $dado ["vencimento_hf"];  ?></td>
                    
                    <td><?php echo $dado ["obs_tec"];  ?></td>
                    <td><?php echo $dado ["data_cad"];  ?></td>
                    <td><?php echo $dado ["id_tec"];  ?></td>
                    
                    
                    
                    <td> <a style="color:black;" href="pdf.php?dc=<?php echo $dado["dc"];?>" target="_blank"  role="button" aria-pressed="true"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
