...
<?php
      ...
      if ($_SESSION['acesso'] == 'ADM')
      {
        ...
        $sql = mysql_query ("select * from base  where cadastro = 'N'" );
      ...
      else
      {
          ...
          $sql = mysql_query ("select * from base where cadastro = 'N' and localidade = '".$_SESSION['localidade']."' ");
...
?>
                <tbody>
                  ...
                  <tr>
                    <td><a href='cadastro.php?dc=<?php echo $dado ["dc"] ?>' ><?php echo $dado ["dc"];  ?></a></td>
