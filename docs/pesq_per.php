...
$sql = mysql_query ("select * from base join cadastro on base.dc = cadastro.dc where data_abertura   BETWEEN '$data' and '$data2' and base.cadastro = 'S' order by data_abertura desc" );
}
else
{
    $sql = mysql_query ("select * from base join cadastro on base.dc = cadastro.dc where data_abertura   BETWEEN '$data' and '$data2' and base.cadastro = 'S' and cadastro.id_tec = '".$_SESSION['id']."' order by data_abertura desc" );
